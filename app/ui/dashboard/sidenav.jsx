...
export default function SideNav() {
    return (
        <div className="flex h-full flex-col px-3 py-4 md:px-2 uppercase font-mono">
            <Link
                className="mb-2 flex h-20 items-end justify-start rounded-md bg-slate-400 p-4 md:h-40"
                href="/"
            >
